...
export const buildTimeSeries = (location: Location): TimeSeries[] => [
  {
    id: 'ts-2023-02',
    date: '2023-02-15',
    sensor: 'Sentinel-2',
...
export const buildSatelliteImages = (location: Location): SatelliteImage[] => [
  {
    id: 'img-before',
    source: 'DEMO DATA · Copernicus Data Space',
    mission: 'Sentinel-2',
...
export const buildChangeDetection = (location: Location): ChangeDetection => ({
  id: 'change-demo-1',
...
export const buildForensicAnalysis = (location: Location): ForensicAnalysis => ({
  id: 'forensics-demo-1',
...
export const buildEvidenceChain = (location: Location): EvidenceItem[] => [
  {
    id: 'evidence-1',
...
export const buildScenario = (location: Location, changePercent: number, scenarioType: string, radius: number): Scenario => ({
  id: 'scenario-demo-1',
